namespace Delagram.Migrations
{
    ...
    public partial class InitialCreate : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        ImageFilter_FilterId = c.Int(),
                    })
                .PrimaryKey(t => t.PostId)
                .ForeignKey("dbo.AspNetUsers", t => t.CreatedBy_Id)
                .ForeignKey("dbo.Filters", t => t.ImageFilter_FilterId)
                .Index(t => t.CreatedBy_Id)
                .Index(t => t.ImageFilter_FilterId);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Posts", "ImageFilter_FilterId", "dbo.Filters");
            ...
            DropIndex("dbo.Posts", new[] { "ImageFilter_FilterId" });
